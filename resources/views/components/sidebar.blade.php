        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'layout' ? 'active' : '' }}">
                <a href="#"
                    ...
                    data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Data Siswa</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('layout-default-layout') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('layout-default-layout') }}">Data Siswa</a>
                    </li>
            ...
            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('blank-page') }}"><i class="fas fa-columns"></i> <span>Data Kelas</span></a>
            </li>
